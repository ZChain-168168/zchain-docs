...
The procedure differs greatly from the way you would want to set up Zchains network for a real use scenario on a cloud provider: [Cloud Setup](../docs/get-started/set-up-ibft-on-the-cloud/)
